...
public class DBPool {
	...
	protected Logger log = Logger.getLogger(DBPool.class);
	...
	private Connection newConnection() {
		...
		try {
			...
			log.info("sorry can't find db driver! : " + e.getMessage(), e);
		} catch (SQLException e1) {
			log.info("sorry can't create Connection! : " + e1.getMessage(), e1);
		}
