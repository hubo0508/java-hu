...
/**
 * @author Administrator TODO 要更改此生成的类型注释的模板，请转至 窗口 － 首选项 － Java － 代码样式 － 代码模板
 */
import java.io.File;
...
/**
 * @author 由月 这个类提供了一些根据类的class文件位置来定位的方法。
 */
public class Path {
	/**
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println(getFullPathRelateClass("/config/jdbc.properties",
					Path.class));
			System.out.println(getFullPathRelateClass("../../../../config/jdbc.properties",
					Path.class));
		}
